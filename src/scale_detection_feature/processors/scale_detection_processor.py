...
# Add parent directory to path to import scale_detection_easyocr
...
class ScaleDetectionProcessor(BaseProcessor):
    ...
    def process_fragment(self, fragment: FragmentRecord, image_path: str) -> ProcessingResult:
        """
        Process a single fragment to detect scale.

        Args:
            fragment: Fragment record from database
            image_path: Absolute path to the fragment image file
