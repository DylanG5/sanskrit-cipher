...
const FilterPanel: React.FC<FilterPanelProps> = ({
  ...
  const [newFilterType, setNewFilterType] = useState<"multiselect" | "text">(
    "multiselect",
  );
  ...
  useEffect(() => {
    setFilterOrder((prev) => {
      ...
      const filtered = prev.filter(
        (id) => builtinSet.has(id) || customIdSet.has(id),
      );
    ...
    <>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background =
              "linear-gradient(270deg, #d97706 0%, #b45309 100%)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background =
              "linear-gradient(270deg, #292524 0%, #44403c 100%)";
          }}
          title="Open filters"
        >
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div
            className="p-4 text-white sticky top-0 z-10 shadow-md font-body"
            style={{
          ...
          >
            ...
            <div className="mb-3 text-xs text-slate-300 bg-white/5 rounded-lg px-3 py-2 border border-white/10">
              <span className="font-semibold">💡 Tip:</span> You can apply
              multiple filters together - they work as AND conditions
            </div>
          ...
          <div className="flex-1 p-4 space-y-0">
            {filterOrder.map((filterId) => {
              ...
              const wrapperStyle: React.CSSProperties = {
                opacity:
                  isDragging && draggedFilterId.current === filterId ? 0.5 : 1,
              ...
              if (filterId === "lineCount") {
                cardContent = (
                  <div
                    className={`bg-white rounded-lg p-4 shadow-sm border-2 transition-all relative ${
                      localFilters.lineCountMin !== undefined ||
                      localFilters.lineCountMax !== undefined
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleLineCountMinChange(e.target.value)
                          }
                          placeholder="Any"
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleLineCountMaxChange(e.target.value)
                          }
                          placeholder="Any"
                          className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
                        />
                    ...
                    {(localFilters.lineCountMin !== undefined ||
                      ...
                      <p className="mt-2 text-xs text-slate-500">
                        {localFilters.lineCountMin ?? "0"} -{" "}
                        {localFilters.lineCountMax ?? "∞"} lines
                      </p>
                    )}
                  </div>
                );
                ...
                cardContent = (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      {localFilters.hasCircle !== null && (
                        <span className="ml-auto text-xs bg-cyan-100 text-cyan-700 px-2 py-0.5 rounded-full font-semibold">
                          Active
                        </span>
                      )}
                    </div>
                ...
                const selectedValues =
                  filter.type === "multiselect" && Array.isArray(value)
                    ? value
                    : [];
                const isActive =
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M7 7h10M7 12h6m-6 5h10M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z"
                        />
                      </svg>
                      <h3 className="font-semibold text-slate-800 text-sm">
                        {filter.label}
