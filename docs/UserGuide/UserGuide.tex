...
\caption{The home screen provides project history, a fragment search bar, and a quick way to start a new project.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{empty_canvas.png}
\caption{A newly opened canvas workspace with the fragment library on the left and the main canvas area ready for placement.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{non-empty_canvas.png}
\caption{A fragment placed on the canvas for inspection and manual arrangement.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{metadata.png}
\caption{The metadata panel lets users review and edit descriptive fields for the selected fragment.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{canvas_with_filter.png}
\caption{The filter panel narrows the fragment library while keeping the current canvas visible for comparison.}
\end{figure}
