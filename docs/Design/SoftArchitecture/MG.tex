...
Behaviour-Hiding & User Interface: UI.Canvas, UI.Search, UI.Auth, UI.Upload, UI.SaveSession, UI.LoadSession \\
Behaviour-Hiding & Service Layer: Svc.API, Svc.Search, Svc.AuthZ, Svc.Session, Svc.ProcOrch, Svc.MatchOrch \\
Behaviour-Hiding & Data Management: Data.FragmentStore, Data.Catalog, Data.User, Data.Project \\
Behaviour-Hiding & Machine Learning Modules: ML.EdgeMatch, ML.ScriptClass, ML.TextSim, ML.Segmentation, ML.CircleRecognition, ML.LineCount, ML.EdgeClassification \\
\midrule
