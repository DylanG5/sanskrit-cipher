...
April 6 & 1.3 & Added low-fidelity user interface wireframes to support workflow planning and frontend implementation\\
\bottomrule
\end{tabularx}
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucWebApp}:] The system will be
  deployed as a web-based application accessible through standard browsers. This is unlikely to change because the system is intended to be accessed through browsers, and changing the deployment model would significantly alter the architecture.
...
Hardware-Hiding & HW.ImageStorage \\
\midrule
