...
\begin{itemize}
    ...
    Provides detailed guidance for scholars on using the platform’s core features, including uploading, searching/filtering, canvas arrangement, metadata editing, and pipeline execution.
