...
% Enforce consistent spacing around section headers.
...
\subsubsection{AI Model Accuracy and Quality Validation}

To ensure the platform is suitable for scholarly use, AI components will be evaluated using training and validation sets. During training, we will track learning curves and summary graphs for metrics such as accuracy, loss, recall, and F1-score. Final model quality decisions will be based on the corresponding values measured on the validation set.

For evaluation, the final validation-set values will be used as the decision criteria, specifically model accuracy together with recall and F1-score. These final values will be reported for each model and used to compare model quality across training runs.
...
\begin{table}[ht]
    ...
    \begin{tabular}{|p{2cm}|p{4cm}|p{4cm}|p{2.5cm}|}
        ...
        \hline
        S.6 & ML pipeline output completeness and model quality & test-nfr-ai-1 (plus final validation-set accuracy, recall, and F1-score reporting) & Manual/automated eval \\
        \hline
...
Supplementary material used by the V\&V process is summarized below.

\subsection{Symbolic Parameters}

No additional symbolic constants are defined in this deliverable.

\subsection{Usability Survey Questions}

Usability survey prompts are documented in the Usability Testing subsection of this plan.
