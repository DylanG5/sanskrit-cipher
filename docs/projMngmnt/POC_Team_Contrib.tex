...
\item \textbf{Linting & Automated Testing}: We will automat linting according to the appropriate style guides, as well as execute our automated test suites where applicable on a PR.
\end{enumerate}
